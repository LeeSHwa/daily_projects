...
# ii) 가로만 더 큰 경우 
    ...
    if y2[1] >= y2[0] and y1[1] < y2[0]:
        print((x2[0] - x1[0]) * (y1[1] - y1[0]))

    # ii-2) 덮인 도형이 사이에 있을 경우
    elif y2[1] < y2[0] and y1[1] > y1[0]:
        print(first_square)

    # ii-3) 덮인 도형이 아래에 있을 경우
    else:
...
# iii) 세로만 더 큰 경우
    ...
    # iii-2) 덮인 도형이 사이에 있을 경우
    elif x2[1] < x2[0] and x1[1] > x1[0]:
        print(first_square)

    # iii-3) 덮인 도형이 왼쪽에 있을 경우
    else:
